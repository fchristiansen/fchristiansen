...
-   🚀 Advanced proficiency in CSS, HTML, SASS, and JavaScript.
-   🎨 Advanced skills in Photoshop, Illustrator, and Figma for design and prototyping.
-   💻 Solid experience in developing custom themes in WordPress.

💼 **Back-End Skills:**

-   🛠️ Experience in development with the MERN stack (MongoDB, Express.js, React, Node.js).
...
![My Skills](https://skillicons.dev/icons?i=html,css,vite,react,tailwind,bootstrap,sass,wordpress&perline=4)

**Back-End Stack**:

![My Skills](https://skillicons.dev/icons?i=mongo,express,nodejs,mysql,php,wordpress&perline=3)
...
![My Skills](https://skillicons.dev/icons?i=vscode,sublime,md,npm,powershell,obsidian&perline=3)
